...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      // The signIn function in AuthContext will handle redirects and success toasts
    ...
    <div className="min-h-screen bg-beige-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-navy-600">
          Or{' '}
          <Link to="/register" className="font-medium text-beige-600 hover:text-beige-700">
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link to="/forgot-password" className="font-medium text-beige-600 hover:text-beige-700">
